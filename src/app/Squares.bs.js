...
var ppx_printed_query = "subscription subscribeFloat  {\nnewFloat  \n}\n";

function parse(value) {
  var value$1 = Js_option.getExn(Js_json.decodeObject(value));
  var match = Js_dict.get(value$1, "newFloat");
  var tmp;
  if (match !== undefined) {
    var value$2 = Caml_option.valFromOption(match);
    var match$1 = Js_json.decodeNumber(value$2);
    tmp = (
        match$1 !== undefined ? match$1 : Js_exn.raiseError("graphql_ppx: Expected float, got " + JSON.stringify(value$2))
      ).toString();
  } else {
    tmp = Js_exn.raiseError("graphql_ppx: Field newFloat on type Subscription is missing");
  }
  return {
          newFloat: tmp
        };
                  ...
                  if (typeof response === "number") {
                    ...
                    return $$Array.mapi((function (index, datum) {
                                  ...
                                  return React.createElement("rect", {
                                              height: String(getRandomInt(30)),
                                              width: String(getRandomInt(30)),
                                              fill: "none",
                                              stroke: getRandomHex(/* () */0),
                                              x: datum.newFloat,
                                              y: match ? datum.newFloat : Caml_array.caml_array_get(d, index - 1 | 0).newFloat
                                            });
                                }), d);
                  }
                })
